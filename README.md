# Logistic-Regression-model-to-Find-Leads-for-an-Educational-Company
Problem Statement
...
I tried to select the most promising leads, i.e. the leads that are most likely to convert
into paying customers. I built a logistic
regression model wherein I assigned a lead score to each of the leads such that the
customers with higher lead score have a
higher conversion chance and vice-versa.
